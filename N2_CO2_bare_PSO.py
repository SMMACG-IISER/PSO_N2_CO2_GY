...
# Specify n/m = 0 for the case of unary cluster geometry optimization
...
def parallel(a, b):
    ...
    # Open a file to log PSO results for N2 and CO2 cluster geometry optimization
    f = open("N2-CO2-bare_PSO", "a")
    f.write("\ntrial: %s" % trial)        
